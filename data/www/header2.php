    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="mainNavbar">
        <ul class="navbar-nav mx-auto d-flex flex-column flex-lg-row justify-content-center align-items-center">
          ...
          <li class="nav-item">
            <a class="nav-link text-white fw-bold fs-5 px-3 my-2 my-lg-0
            <?php echo basename($_SERVER['PHP_SELF']) === 'predmeti.php' ? 'active' : ''; ?>"
              href="predmeti.php">
              Vsi predmeti
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link text-white fw-bold fs-5 px-3 my-2 my-lg-0
            <?php echo basename($_SERVER['PHP_SELF']) === 'dodajPredmet.php' ? 'active' : ''; ?>"
              href="dodajPredmet.php">
              Dodaj predmet
            </a>
          </li>
